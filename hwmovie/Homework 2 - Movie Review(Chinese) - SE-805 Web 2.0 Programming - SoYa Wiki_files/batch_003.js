        ...
        function updateLikeSummary(data, $summaryContainer) {
            ...
            $summaryContainer
                ...
                .find(".likes").click(function () {
                    ...
                    likesDialog.addCancel("\u786E\u8BA4", function (dialog) {
                        dialog.remove();
                        likesDialog = undefined;
                    });
